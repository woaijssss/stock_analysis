class StockForms(object):
    ...
    def init(self):
        self.__topFlipForms = [0x000, 0x002, 0x100, 0x101, 0x104, 0x106, 0x108, 0x201, 0x203, 0x204, 0x205]
        self.__buttomFlipForms = [0x001, 0x100, 0x102, 0x103, 0x105, 0x107, 0x109, 0x200, 0x202]
